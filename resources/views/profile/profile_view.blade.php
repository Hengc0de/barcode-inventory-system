        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{url('upload/profile_pictures/'.$profileData->avatar)}}" alt="Profile" class="rounded-circle">
                    @else
...
{{-- 
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Cambodia</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Address</div>
                    <div class="col-lg-9 col-md-8">Kjel oy insert</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">Kjel ter</div>
                  </div>
                ...
                <div class="tab-pane fade show active  profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="post" action="{{route('profile.store')}}" enctype="multipart/form-data" >
                    ...
                    <div class="text-center mb-3">
                      @if (!empty($profileData ->avatar))
                      <img src="{{url('upload/profile_pictures/'.$profileData->avatar)}}" id="showAvatar" alt="Profile" class="rounded-circle">
                            @else
                      <img src="{{url('upload/noimage.jpg') }}" alt="Profile"  id="showAvatar" class="rounded-circle">
